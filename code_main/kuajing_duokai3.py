...
def CR(channel, msg):
    ...
    co1 = ChromiumOptions().set_local_port(9115)
    ...
    if countflag>1:
        ...
        countflag = f"{countflag:04d}"
        element = page.ele(f'xpath://*[@id="span_TELNUME_CORRE_{countflag}"]/a')
        url = element.attr("href")

        # countflag = f"{countflag:04d}"
        elementname = page.ele(f'xpath://*[@id="span_TELNUME_CORRE_{countflag}"]/a').text
        # print(elementname)   //*[@id="span_TELNUME_CORRE_3013"]/a。//*[@id="span_TELNUME_CORRE_0003"]/a
